...
variable "public_subnet_tags" {
  description = "Extra tags merged into every public subnet (e.g. kubernetes.io/role/elb for EKS auto-discovery)"
  type        = map(string)
  default     = {}
}

variable "private_subnet_tags" {
  description = "Extra tags merged into every private subnet (e.g. kubernetes.io/role/internal-elb for EKS auto-discovery)"
  type        = map(string)
  default     = {}
}